...
function updateSubcategoryDropdown() {
    ...
    if (type === 'expense' && category && categories.expense[category]) {
        ...
        transactionSubcategory.style.display = 'block';
    } else {
        transactionSubcategory.style.display = 'none';
    }
}
...
function updateTransactionsList() {
    transactionsList.innerHTML = transactions.map(transaction => `
        <div class="entry-item ${transaction.type}">
...
// Add the logout button styles to your CSS
